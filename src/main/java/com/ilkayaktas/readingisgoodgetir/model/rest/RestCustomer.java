...
import com.ilkayaktas.readingisgoodgetir.model.validator.UsernameAndEmailUniqueCriteria;
import lombok.*;
...
public class RestCustomer {
   ...
   private String name;
   @UsernameAndEmailUniqueCriteria(message = "Duplicated email!")
   ...
   @UsernameAndEmailUniqueCriteria(message = "Duplicated username!")
